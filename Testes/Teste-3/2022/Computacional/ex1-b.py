# -*- coding: utf-8 -*-
"""
Created on Wed Jun 21 10:25:58 2023
...
Ep[0] = 1/2 * k * x0**2 + alpha * x0**3 - b * x0**4
...
for i in range(Nt-1):
    ...
    Ep[i+1] = 1/2 * k * x[i+1]**2 + alpha * x[i+1]**3 - b * x[i+1]**4
...
print("Frequencia: ",np.round(frequencia,4),"0",sep="") 
...
plt.savefig(dir_figs+'ex1-d).png') # Save the graph in png
