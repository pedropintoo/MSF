# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 15:00:40 2023
...
tempo = np.array(     [    0,   48,   96,  144,  192,  240,  288,  336, 384 ]) # X
atividade = np.array([ 10.03, 7.06, 4.88, 3.38, 2.26, 1.66, 1.14, 0.79, 0.58 ])  # Y

plt.plot(tempo, atividade, marker='s', linestyle='none', color='purple')
plt.xlabel('tempo (h)')
...
# regressão linear
m, b, r2, delta_m, delta_b = lin_reg(tempo,atividade, 1)
