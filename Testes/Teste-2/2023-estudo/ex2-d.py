# -*- coding: utf-8 -*-
"""
Created on Wed May 10 18:10:22 2023
...
g = 9.8
x0 = 0
v0 = 20  # empurao de 20m/s
a0 = 0  

ang = -5 # graus

pot = -30000 # -30k potencia (W)
...
for i in range(Nt - 1):
    ...
    a[i] = np.abs( 1 / m * (pot/v[i] - N * Catr - Px - D * v[i] * v_norma ) ) 
...
print("d) Percorre 2000 metros depois de",t_tempo_v," segundos")
...
print("d) Trabalho realizado é: ",Wmotor)
...
plt.savefig(dir_figs+'2-d.png') # Save the graph in png
